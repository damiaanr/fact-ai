...
sys.path.insert(0, "/Users/danie/Desktop/Uni/FACT/ELDR-upgraded/scvis/lib/scvis/")
...
def load_vae(input_dim, model_file, feature_transform = None):
    ...
    try:
        ...
        config_file_yaml = open("/Users/danie/Desktop/Uni/FACT/ELDR-upgraded/scvis/lib/scvis/config/model_config.yaml", "r")
